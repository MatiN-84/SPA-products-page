        ...
        <>
          ...
          <div className="w-120">
            ...
            <div className="flex justify-between p-2">
              <Link to="/products">
              <button className="font-bold text-[#16a34a] p-2 border-2 border-[#16a34a] rounded mt-[10px] hover:bg-[#16a34a] hover:text-white cursor-pointer transition duration-100 ease-in">
                Buy more
              </button></Link>
              <button 
              onClick={()=>dispatch( clearAll())}
              className="font-bold text-red-500 p-2 border-2 border-red-500 rounded mt-[10px] hover:bg-red-500 hover:text-white cursor-pointer transition duration-100 ease-in">
                Clear cart
              </button>
            </div>
          </div>
          <div className="h-50 border-2 border-[#16a34a] rounded-lg text-[1.3rem] text-[#075985] font-medium p-4 w-80">
            ...
            <button className="w-[100%] bg-[#16a34a] text-white mt-5 p-1 hover:text-red-500 border-2 border-green-600 hover:bg-white cursor-pointer">
              Checkout
            </button>
          </div>
        </>
